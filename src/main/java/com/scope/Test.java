 ...
 *
 * @author garen
 * Date: 2023/12/8 11:31
 * Description: Test
 */
public class Test {

    /*public static void main(String[] args) {
        String abi = "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"bytes32\",\"name\":\"id\",\"type\":\"bytes32\"}],\"name\":\"RevokeNotify\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"_id\",\"type\":\"bytes32\"}],\"name\":\"emitRevokeLog\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]";
//        String bin = "{\n" +
//                "\t\"linkReferences\": {},\n" +
...
//                "}";
        ...
        String abiFileName = "mySmartContract.abi";
        String binFileName = "mySmartContract.bin";
        GeneratorAbiAndBinUtils.generateABIAndBIN(abi,bin,abiFileName,binFileName);

        String abiFile = "src/main/resources/mySmartContract.abi";
        String binFile = "src/main/resources/mySmartContract.bin";
        String generateFile = "src/main/java/com/scope/utils/";
        GeneratorAbiAndBinUtils.generateClass(abiFile,binFile,generateFile);
    }*/

    // 0x159c3Ac104De02c141BC5A89a79FD6C1f0202794
    // 86f9b0c8e47a67bd15c57bcd9b26b5ffe02e1f2399288e9c80b93bf00df4bf8d
...
//        MySmartContract contract = MySmartContract.load(contractAddress, web3, getCredentials(privateKey), new DefaultGasProvider());
        ...
        byte[] byteValue = "25bac377a1dcfd0687365aa0eb18051".getBytes();
